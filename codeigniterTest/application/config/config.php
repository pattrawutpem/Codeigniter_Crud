...
define('PROTOCAL', 'http'); // http for development https for product
define('APPBASE', PROTOCAL . "://{$_SERVER['SERVER_NAME']}" . str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']));
